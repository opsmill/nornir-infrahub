...
An object representing the outcome of the operation, indicating success or failure.
...
An object containing the retrieved artifact data, its content type, and the success status of the operation.
