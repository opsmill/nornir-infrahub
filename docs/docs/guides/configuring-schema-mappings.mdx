...
Use the Infrahub GraphQL explorer to understand available attributes. Based on the example schema from the [Getting Started guide](../getting-started.mdx#example-schema-structure), you can query:
